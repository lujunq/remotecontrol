...
:: Android packaging
set AND_CERT_NAME="remotecontrol"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\remotecontrol.p12
...
set IOS_PROVISION=cert\remotecontrol.mobileprovision
...
:: Desktop packaging
set DESK_CERT_NAME="remotecontrol"
set DESK_CERT_PASS=fd
set DESK_CERT_FILE=cert\remotecontrol.p12
...
set APP_ID=air.remotecontrol

:: Output packages
set DIST_PATH=dist
set DIST_NAME=remotecontrol
